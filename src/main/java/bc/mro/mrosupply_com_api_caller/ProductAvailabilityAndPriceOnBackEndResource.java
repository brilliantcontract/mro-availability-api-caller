...
@Path("product-availability-and-price-on-back-end")
public class ProductAvailabilityAndPriceOnBackEndResource {
     ...
     */
    public ProductAvailabilityAndPriceOnBackEndResource() {
    }
