...
public class ApiCallerFrontEndLoggedOut {
    ...
    public ApiCallerFrontEndLoggedOut() {
    ...
    public ApiResponse call(final String productId, String rawCookies) {
        ...
        Invocation.Builder req = client
                ...
                .header("Referer", "https://www.mrosupply.com/hydraulics-and-pneumatics/106111_abb_dixon/");
    ...
    private static final String BASE_URL = "https://www.mrosupply.com/api/v2/product/";
    private static final String SUFIX_URL = "/availability/";

    private String generateApiUrl(String productId) {
        String url = BASE_URL + productId + SUFIX_URL;
        return url;
    }
