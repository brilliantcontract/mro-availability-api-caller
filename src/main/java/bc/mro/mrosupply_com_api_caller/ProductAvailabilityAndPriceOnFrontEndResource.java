...
@Path("product-availability-and-price-on-front-end")
public class ProductAvailabilityAndPriceOnFrontEndResource {
     ...
     */
    public ProductAvailabilityAndPriceOnFrontEndResource() {
    }
    ...
    public Response fetchAvailability(@FormParam("cookies") String rawCookies,
        ...
        ApiCallerFrontEnd apiCallerFrontEnd = new ApiCallerFrontEnd();
        ApiResponse apiResponse = apiCallerFrontEnd.call(productId, rawCookies);
    ...
    public String getJson() {
        return "How to use:\n\n"
                ...
                + "     https://mroscrape.top:4002/mro-availability-api-caller/resources/product-availability-and-price-on-front-end\n\n\n"
                + "curl -X POST \\\n"
